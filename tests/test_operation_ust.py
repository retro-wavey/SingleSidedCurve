...
def test_ust_fresh_vault(ust, ustCurvePool,Strategy,strategy_ust,ustyvault,ust3CRV, rewards,chain,ust_vault, ychad, whale,gov,strategist, interface):

    vault = ust_vault
    yvault = ustyvault
    strategy = strategy_ust
    currency = ust
    debt_ratio = 10_000
