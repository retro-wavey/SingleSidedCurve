...
def zap_strategy(Contract, strategist, keeper, vault, Strategy):
    sharer = Contract("0xc491599b9A20c3A2F0A85697Ee6D9434EFa9f503")
    sam = "0xC3D6880fD95E06C816cB030fAc45b3ffe3651Cb0"
    juan = "0xB28Af40C766044915d6f45313d2A8d94481F646F"
    poolpi = "0x03ebbFCc5401beef5B4A06c3BfDd26a75cB09A84"

    susd_vault = Contract("0xa5cA62D95D24A4a350983D5B8ac4EB8638887396")
    ssc_saave = Contract("0x74b3E5408B1c29E571BbFCd94B09D516A4d81f36")
    ...
    yield strategist.deploy(
        Strategy,
        susd_vault,
        ssc_saave.maxSingleInvest(),
        ssc_saave.minTimePerInvest(),
        ssc_saave.slippageProtectionIn(),
        susd2_pool,
        susd2_zap,
        susd2_token,
        crv_susd2_vault,
