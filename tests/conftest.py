...
@pytest.fixture
def live_strat_dai_migrated(Strategy):
    yield Strategy.at('0x30010039Ea4a0c4fa1Ac051E8aF948239678353d')
...
def strategy_usdt_ib(
    strategist, keeper, live_usdt_vault, Strategy, ibCurvePool, ib3CRV, ibyvault
):
